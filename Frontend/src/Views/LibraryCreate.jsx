                            ...
                            <div className="Box_Image">
                                <div className="Element_Group">
                                    ...
                                    <div className="ImageInput">
                                        ...
                                        />
                                        <p onPaste={(e) => handlePasteImage(e, "imagen")}>Pega, arrastra o selecciona una imagen</p>
                                    </div>
                                </div>
                                <div className="Element_Group">
                                    <label>Portada</label>
                                    <div className="ImageInput">
                                        ...
                                        />
                                        <p onPaste={(e) => handlePasteImage(e, "imagenP")}>Pega, arrastra o selecciona una imagen</p>
                                    </div>
                                </div>
                            </div>
